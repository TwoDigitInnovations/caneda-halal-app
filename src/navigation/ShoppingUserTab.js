...
import Account from '../screen/shopping/user/Account';
...
export const  Shoppingtab=()=>{
 ...
 const { t } = useTranslation();
  const TabArr = [
    ...
    // {
    //   iconActive: <CategoriesIcon color={Constants.dark_green} height={25} width={25} />,
    //   iconInActive: <CategoriesIcon color={Constants.tabgrey} height={25} width={25} />,
    //   component: ShoppingCategories,
    //   routeName: 'ShoppingCategories',
    //   name: t('Categories'),
    // },
    {
      ...
      component: ShoppingShops,
      routeName: 'ShoppingShops',
      name: t('Shops'),
    },
    {
  ...
  const TabButton = useCallback(
    ({accessibilityState, onPress, onclick, item,index}) => {
      const cartCount = shoppingcartdetail?.length || 0;
