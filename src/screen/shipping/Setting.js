...
import { LoadContext, ProfileContext, ToastContext, TranslatorContext, UserContext} from '../../../App';
import {
  CrossIcon,
  DeleteIcon,
  LanguageIcon,
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <TouchableOpacity
          ...
          <View style={{marginTop: 5, alignItems: 'center'}}>
            <Text style={styles.protxt}>{profile?.username?profile?.username:user?.username}</Text>
            <Text style={styles.protxt2}>{profile?.phone?profile?.phone:user?.phone}</Text>
          </View>
        </TouchableOpacity>
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <View style={styles.btmboxfirpart}>
              <View style={styles.iconcov}>
                <LogoutIcon height={20} width={20} color={Constants.black} />
              </View>
              <Text style={[styles.protxt,{width:'70%'}]}>{t("Log Out")}</Text>
            </View>
            <RightArrow
              color={Constants.black}
              height={15}
