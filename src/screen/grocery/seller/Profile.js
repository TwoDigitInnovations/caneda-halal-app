...
import {FoodSellerContext, GrocerySellerContext, LoadContext, ToastContext} from '../../../../App';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View
        ...
        {userDetail?.store_cover_img?<TouchableOpacity style={{width: '55%'}} disabled={!edit} onPress={() => {
                    Keyboard.dismiss();
                    setTimeout(() => {
...
export default GrocerySellerProfile;
