    ...
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({item, index}) => {
          ...
          return(
          <TouchableOpacity style={styles.shoppart} onPress={() => navigate('GroceryShopDetail',{store_cover_img:item?.store_cover_img,store_logo:item?.store_logo,store_name:item?.store_name,distance:item?.distance,store_id:item?.user,status:status,nextOpen:nextOpen})}>
            <Image
