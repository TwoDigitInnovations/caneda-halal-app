...
import {BackIcon, TikIcon} from '../../../../Theme';
import {goBack} from '../../../../navigationRef';
import Constants, {Currency, FONTS} from '../../../Assets/Helpers/constant';
import { ShoppingSellerContext, LoadContext, UserContext} from '../../../../App';
import {GetApi, Post} from '../../../Assets/Helpers/Service';
import { useTranslation } from 'react-i18next';

const ShoppingWithdraw = () => {
  ...
  const submit = async () => {
    const data = {
      req_user: user?._id,
      req_profile: shoppingsellerProfile?._id,
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.amtline}>
        ...
        <Text style={styles.amttxt2}>{Currency}{shoppingsellerProfile?.wallet}</Text>
      </View>
      ...
      {Number(amount) > 0 && (
        <Text style={styles.amtins}>
          {t("After deducting 5% service charge, you will receive",{tax:tax?.shoppingTaxRate})} {Currency}
          {(Number(amount) - (Number(amount) * 5) / 100).toFixed(2)}
        </Text>
      )}
      {Number(amount) > shoppingsellerProfile?.wallet && (
...
export default ShoppingWithdraw;
