...
import {  ShoppingSellerContext, TranslatorContext } from '../../../../App';
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.toppart}>
        ...
        <Text style={styles.headtxt3}>{Currency}{shoppingsellerProfile?.wallet?shoppingsellerProfile?.wallet:0}</Text>
        <Text style={styles.headtxt4} onPress={()=>navigate('ShoppingWithdraw')}>{t("Withdraw")}</Text>
      </View>
<ScrollView showsVerticalScrollIndicator={false}>
      <View style={styles.card}>
        <TouchableOpacity
          style={[styles.box]}
          onPress={() => navigate('ShoppingSellerProfile')}>
      ...
      <TouchableOpacity
          style={[styles.box]}
          onPress={() => navigate('ShoppingSellerOrder')}>
          <View style={styles.btmboxfirpart}>
            <View style={styles.iconcov}>
