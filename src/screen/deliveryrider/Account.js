...
import { DeliveryRiderContext, FoodSellerContext, TranslatorContext } from '../../../App';
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.toppart}>
        ...
        <Text style={styles.headtxt3}>{Currency}{deliveryriderProfile?.wallet?deliveryriderProfile?.wallet:0}</Text>
        <Text style={styles.headtxt4} onPress={()=>navigate('DeliveryRiderWithdraw')}>{t("Withdraw")}</Text>
      </View>
<ScrollView showsVerticalScrollIndicator={false}>
      <View style={styles.card}>
        <TouchableOpacity
          style={[styles.box]}
          onPress={() => navigate('DeliveryRiderProfile')}>
      ...
      <TouchableOpacity
          style={[styles.box]}
          onPress={() => navigate('DeliveryRiderHistory')}>
          <View style={styles.btmboxfirpart}>
            <View style={styles.iconcov}>
