            ...
            <View style={styles.revcov}>
              ...
              <TouchableOpacity style={styles.box}>
                ...
                <View  style={styles.foodcov}>
                  {item?.foodImage&&<Image
                    source={{uri: item?.foodImage}}
                    style={styles.foodimg}
                  />}
                <Text style={styles.boxtxt3}>{item?.foodName}</Text>
                </View>
                <StarRatingDisplay
                ...
                />
                <Text style={styles.boxtxt4}>{item?.foodDescription}</Text>
              </TouchableOpacity>
            </View>
          )}
          ListEmptyComponent={() => (
