...
if (selecteddays.length==0){ 
  ...
  return;
    ...
    // }
    setLoading(true);
    Post('updateProfile/FOODSELLER', userDetail, {}).then(
      async res => {
        setLoading(false);
        console.log(res);
        ...
        <View style={styles.twoimgcov}>
          {userDetail?.store_logo ? (
            <TouchableOpacity
              ...
              <Image
                source={{uri: userDetail?.store_logo}}
          ...
          {userDetail?.store_cover_img ? (
            <TouchableOpacity
              ...
              <Image
                source={{uri: userDetail?.store_cover_img}}
                style={styles.imagest2}
              />
            </TouchableOpacity>
          ) : (
            <TouchableOpacity
...
export default FoodSellerProfile;
