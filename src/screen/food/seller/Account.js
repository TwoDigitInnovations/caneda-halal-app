...
import { FoodSellerContext, TranslatorContext } from '../../../../App';
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.toppart}>
        ...
        <Text style={styles.headtxt3}>{Currency}{foodsellerProfile?.wallet?foodsellerProfile?.wallet:0}</Text>
        <Text style={styles.headtxt4} onPress={()=>navigate('Withdraw')}>{t("Withdraw")}</Text>
      </View>
<ScrollView showsVerticalScrollIndicator={false}>
      <View style={styles.card}>
        <TouchableOpacity
          style={[styles.box]}
          onPress={() => navigate('FoodSellerProfile')}>
      ...
      <TouchableOpacity
          style={[styles.box]}
          onPress={() => navigate('FoodSellerOrder')}>
          <View style={styles.btmboxfirpart}>
            <View style={styles.iconcov}>
