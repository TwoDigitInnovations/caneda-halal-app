...
import { DriverProfileContext, LoadContext} from '../../../../App';
import {GetApi} from '../../../Assets/Helpers/Service';
import moment from 'moment';
import { useTranslation } from 'react-i18next';

const RideDriverTransactionHistory = () => {
  ...
  const getTransaction = () => {
    setLoading(true);
    GetApi(`getTransaction/${driverProfile?._id}?req_user_type=driver`, {}).then(
      async res => {
        setLoading(false);
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.amtline}>
        ...
        <Text style={styles.amttxt2}>{Currency}{driverProfile?.wallet}</Text>
      </View>
      <FlatList
...
export default RideDriverTransactionHistory;
