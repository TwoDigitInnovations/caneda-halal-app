...
import { DriverProfileContext, LoadContext, TranslatorContext } from '../../../../App';
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.toppart}>
        ...
        <Text style={styles.headtxt3}>{Currency}{driverProfile?.wallet?driverProfile?.wallet:0}</Text>
        <Text style={styles.headtxt4} onPress={()=>navigate('DriverWithdraw')}>{t("Withdraw")}</Text>
      </View>
<ScrollView showsVerticalScrollIndicator={false}>
      <View style={styles.card}>
        ...
        {/* <TouchableOpacity
            style={[styles.box]}
            onPress={() => navigate('DeliveryRiderNotification')}>
            <View style={styles.btmboxfirpart}>
              <View style={styles.iconcov}>
                <Notification2Icon height={20} width={20} color={Constants.custom_green}/>
              </View>
              <Text style={styles.protxt}>Notification</Text>
            </View>
            <RightArrow
      ...
      <TouchableOpacity
          style={[styles.box]}
          onPress={() => navigate('DriverHistory')}>
          <View style={styles.btmboxfirpart}>
            <View style={styles.iconcov}>
              <GridIcon height={20} width={20} color={'#18CFE8'}/>
            </View>
            <Text style={styles.protxt}>{t("History")}</Text>
          </View>
          <RightArrow
            color={Constants.customgrey2}
            height={15}
      ...
      <TouchableOpacity
          style={[styles.box]}
          onPress={() => navigate('RideDriverTransactionHistory')}>
          <View style={styles.btmboxfirpart}>
            <View style={styles.iconcov}>
      ...
      <TouchableOpacity
          style={[styles.box]}
          onPress={() => navigate('DriverReviews')}>
          <View style={styles.btmboxfirpart}>
            <View style={styles.iconcov}>
