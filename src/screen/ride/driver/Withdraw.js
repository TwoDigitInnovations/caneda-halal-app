...
import { LoadContext, UserContext,DriverProfileContext} from '../../../../App';
...
const DriverWithdraw = () => {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      {Number(amount) > driverProfile?.wallet && (
      ...
      <TouchableOpacity
        ...
        onPress={() => {
          if (Number(amount) > 0 &&Number(amount) <= driverProfile?.wallet &&amount) {
              submit();
          }
        }}>
        <Text
